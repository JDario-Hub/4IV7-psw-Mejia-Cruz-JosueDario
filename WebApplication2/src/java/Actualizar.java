...
public class Actualizar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            nom = request.getParameter("nombree");
            appat = request.getParameter("appatt");
            apmat = request.getParameter("appmatt");
            correo = request.getParameter("emaill");
            edad = Integer.parseInt(request.getParameter("edadd"));
            
         String q="UPDATE mregistro SET nom_usu = '"+nom+"', appat_usu = '"+appat+"',"
                            + " apmat_usu = '"+apmat+"', edad_usu = '"+edad+"', email_usu = '"+correo+"' where id_usu ="+id;
         ...
         try{
            ...
            out.println("<br>"
                    ...
                    + "<br>");
                out.println("<h1>Registro al Actualizar</h1>");
